  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white py-14">
      <section className="max-w-6xl mx-auto px-6">
        <div className="mb-10">
          <div className="inline-block rounded-full bg-brand-purple px-6 py-2 text-xs tracking-[3px]">
            TOURNAMENTS
          </div>
          <h1 className="mt-4 text-4xl font-bold tracking-tight md:text-5xl">Tournament Brackets</h1>
        ...
        {brackets.length > 0 ? (
          <div className="space-y-8">
            {brackets.map((bracket) => (
              <article key={bracket.id} className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-5">
