...
import { normalizeSourceKey, previewGameChangerScores } from "@/lib/gamechanger/unifiedScoreSync";
...
export async function POST(request: NextRequest) {
  ...
  const data = await previewGameChangerScores({ organizationId: body.organizationId, seasonYear, sourceType: body.sourceType, sourceKey: normalizeSourceKey(body.sourceType, body.sourceKey || "") });
