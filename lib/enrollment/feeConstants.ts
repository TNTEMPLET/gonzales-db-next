 ...
 * fee). Parish Rec remittance is 10% of that net (Jason "Doc" Adams,
 * 2026-09-18). If these ever legitimately vary by org, season, or payment
...
/** Ascension Parish Rec share of net registration income (after CC + SportsConnect fees). */
export const PARISH_REC_SHARE_RATE = 0.1;
